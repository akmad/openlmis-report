package mw.gov.health.lmis.settings.service;

import static mw.gov.health.lmis.settings.i18n.ConfigurationSettingMessageKeys.ERROR_CONFIGURATION_SETTING_NOT_FOUND;
